// Mapeamento completo de championId para nome do campeão (Data Dragon)
// Fonte: https://ddragon.leagueoflegends.com/cdn/14.3.1/data/en_US/champion.json
...
export function championIdToName(championId: number): string {
  return CHAMPION_ID_TO_NAME[championId] || 'Unknown'
}
